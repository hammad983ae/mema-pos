  ...
  return (
    <Routes>
      ...
      <Route
        path="/onboarding"
        element={
          <AuthGuard requireAuth={true} requireBusiness={false}>
            <Onboarding />
          </AuthGuard>
        }
      />
      ...
      <Route
        path="/dashboard"
        element={
          <AuthGuard requireAuth={true} requireBusiness={true}>
            <Dashboard />
          </AuthGuard>
        }
      />
