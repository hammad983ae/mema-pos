...
export default function CheckoutSalesTeam() {
  ...
  useEffect(() => {
    // Debug logging
    console.log('CheckoutSalesTeam - customerData:', customerData);
    console.log('CheckoutSalesTeam - paymentData:', paymentData);
    console.log('CheckoutSalesTeam - paymentData.length:', paymentData?.length);
  ...
  const handleContinue = () => {
    ...
    localStorage.setItem('checkout_sales_team', JSON.stringify(selectedSalesPeople));
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="font-bold text-xl">${cartData.total?.toFixed(2) || '0.00'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
