...
const Settings = () => {
  ...
  const [membership, setMembership] = useState<UserBusinessMembership | null>(null);
  ...
  const subscriptionPlans = [
    { value: "starter", label: "Starter - $29/month", description: "Basic features for small teams" },
    { value: "professional", label: "Professional - $79/month", description: "Advanced features for growing businesses" },
    { value: "enterprise", label: "Enterprise - $199/month", description: "Full feature set for large organizations" }
  ];
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      if (membershipData) {
        ...
        if (membershipData.businesses?.invitation_code && 
            (membershipData.role === "business_owner" || membershipData.role === "manager")) {
  ...
  const isEmployee = membership?.role === "employee" || membership?.role === "salesperson";
      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center gap-2">
                <div className="bg-primary/5 border border-primary/20 rounded-lg px-3 py-2">
                  <div className="flex items-center gap-2">
                    ...
                    <code className="font-mono text-sm font-medium">{invitationCode}</code>
                    <Button 
                      variant="ghost" 
                      size="sm" 
        ...
        <Tabs className="space-y-6">
              ...
              {isBusinessOwner && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Manage your account password for online access and subscriptions
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <Alert>
                      ...
                      <AlertDescription>
                        This password is used for online access to manage subscriptions and support. 
                        Employees use PIN-based authentication for POS access.
                      </AlertDescription>
                    </Alert>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      <Button onClick={updatePassword} disabled={loading} variant="default">
              ...
              {(isBusinessOwner || isManager || isOffice) ? (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Access the Point of Sale system for processing transactions and managing sales.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <Alert>
                      <ShoppingCart className="h-4 w-4" />
                      <AlertDescription>
                        As a manager or owner, you have direct access to the POS terminal. 
                        Employee POS credentials can be managed in Store Management.
                      </AlertDescription>
                    </Alert>
                    ...
                    <div className="flex flex-col gap-4">
                      <Button 
                        onClick={async () => {
                          try {
                            console.log('Creating POS session for settings access...');
                            ...
                            if (!activeStore) {
                              ...
                              toast({
                                ...
                                description: "No active store found. Please contact your administrator.",
                                variant: "destructive"
                              });
                              return;
                            }
                            ...
                            console.log('Day session created/found:', daySession);
            ...
            <TabsContent value="business">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {hasBusinessAccess ? "Manage business details and settings" : "View your business information"}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setBusiness(prev => prev ? { ...prev, email: e.target.value } : null)}
                        disabled={!hasBusinessAccess}
          ...
          <TabsContent value="locations">
            <StoreLocationSettings userRole={membership?.role || ""} />
          </TabsContent>

          <TabsContent value="team">
            <UserRoleSettings userRole={membership?.role || ""} />
          </TabsContent>

          <TabsContent value="payments">
            <PaymentSettings userRole={membership?.role || ""} />
          </TabsContent>

          <TabsContent value="notifications">
            <NotificationSettings userRole={membership?.role || ""} />
          </TabsContent>

          <TabsContent value="system">
            <SecuritySettings userRole={membership?.role || ""} />
          </TabsContent>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-secondary rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Status: <Badge variant={business.subscription_status === "active" ? "default" : "destructive"}>
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        toast({
                          title: "Feature Coming Soon",
                          description: "Billing history feature will be available soon.",
                        });
                      }}
                    >
                      Billing History
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      Contact support for immediate changes or cancellations.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
