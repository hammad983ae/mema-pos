...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-button hover:shadow-button-hover hover:-translate-y-0.5",
        destructive:
        ...
        premium:
          "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-strong hover:-translate-y-1 hover:scale-105",
        glass:
          "bg-white/10 text-foreground border border-white/20 backdrop-blur-sm hover:bg-white/20 shadow-soft hover:shadow-medium hover:-translate-y-0.5",
      },
      size: {
