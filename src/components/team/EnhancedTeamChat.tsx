...
import { Hash, Users, Settings, MoreVertical } from "lucide-react";
...
export const EnhancedTeamChat = ({}: EnhancedTeamChatProps) => {
  const { user } = useAuth();
    ...
    if (announcementChannel) {
      try {
        ...
        toast({
          ...
          description:
            "The sales announcement has been posted to the announcements channel.",
        });
      } catch (error) {
