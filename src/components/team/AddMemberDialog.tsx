            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Share this code with new team members. They can use it during
                  signup to join your business.
                </p>
              </CardContent>
            </Card>
          )}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(
                  value: "employee" | "manager" | "business_owner" | "office",
                ) =>
                  setNewMemberData((prev) => ({
                    ...prev,
                    role: value,
                    positionType: value === "employee" ? prev.positionType : "",
                  }))
                }
              >
                <SelectTrigger>
            ...
            {newMemberData.role === "employee" && (
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Choose the employee's specialization for sales tracking and
            ...
            <Button
              ...
              disabled={
                loading || !newMemberData.email || !newMemberData.fullName
              }
              className="w-full"
            >
