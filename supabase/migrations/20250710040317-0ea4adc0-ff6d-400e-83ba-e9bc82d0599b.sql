...
ALTER TABLE public.sales_training_modules ADD CONSTRAINT fk_training_modules_business 
  FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;

ALTER TABLE public.sales_training_sessions ADD CONSTRAINT fk_training_sessions_business 
  FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;

ALTER TABLE public.sales_training_progress ADD CONSTRAINT fk_training_progress_business 
  FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;

ALTER TABLE public.sales_training_goals ADD CONSTRAINT fk_training_goals_business 
  FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;

ALTER TABLE public.sales_training_achievements ADD CONSTRAINT fk_training_achievements_business 
  FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;
