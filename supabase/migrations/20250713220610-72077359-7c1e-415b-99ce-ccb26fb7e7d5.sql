...
-- Create 10 sample employee profiles (without POS PIN for now)
INSERT INTO public.profiles (user_id, username, full_name, email, position_type, phone, business_id)
SELECT 
